...
A relação Energia Final / Energia Útil tem a dimensão de rendimento energético. O BEU permite avaliar o rendimento energético global da sociedade brasileira e os rendimentos específicos dos setores de atividade, das diferentes formas de energia e dos Usos Finais. A @tab-evolucao-rendimentos-energeticos-setores apresenta as evoluções dos rendimentos energéticos globais, dos principais setores de atividades, dos principais energéticos e dos principais Usos Finais.
...
```{r}
#| label: tab-evolucao-rendimentos-energeticos-setores-efeitos
#| tab-cap: 'Evolução dos Rendimentos, Energéticos, Setores e Usos Finais Brasil'
benCorrido::tab_evolucao_rendimentos_energeticos_setores_efeitos(con, lab1 = "")
```

Na @tab-variacao-rendimentos-energeticos-participacao são apresentadas as variações referentes a todos os segmentos considerados neste estudo.

```{r}
#| label: tab-variacao-rendimentos-energeticos-participacao
#| tab-cap: 'Variação dos Rendimentos Energéticos, Participação dos Efeitos da Tecnologia e da Sociedade – Brasil'
