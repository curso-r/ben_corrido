...
```{r}
benCorrido::tab_producao_energia_primaria(con)
```

```{r}
linha <- benCorrido::grafico_producao_energia_primaria_linha(con, .tipo = "Absoluto")
area <- benCorrido::grafico_producao_energia_primaria_area(con, .tipo = "Absoluto")
...
```{r}
benCorrido::tab_producao_energia_primaria(con, .tipo = "Percentual")
```


```{r}
linha <- benCorrido::grafico_producao_energia_primaria_linha(con, .tipo = "Percentual")
area <- benCorrido::grafico_producao_energia_primaria_area(con, .tipo = "Percentual")
...
```{r}
benCorrido::tab_oferta_interna_energia(con)
```

```{r}
linha <- benCorrido::grafico_oferta_interna_energia_linha(con, .tipo = "Absoluto")
area <- benCorrido::grafico_oferta_interna_energia_area(con, .tipo = "Absoluto")
...
```{r}
linha <- benCorrido::grafico_oferta_interna_energia_linha(con, .tipo = "Percentual")
area <- benCorrido::grafico_oferta_interna_energia_area(con, .tipo = "Percentual")
...
```{r}
benCorrido::tab_consumo_final_fonte(con)
```
