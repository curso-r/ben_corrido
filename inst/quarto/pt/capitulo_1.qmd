...
benCorrido::tab_producao_energia_primaria(con, .tipo_dado = "Absoluto")
...
benCorrido::tab_producao_energia_primaria(con, .tipo_dado = "Percentual")
...
benCorrido::tab_oferta_interna_energia(con, .tipo = "Absoluto")
...
linha <- benCorrido::grafico_oferta_interna_energia(con, .tipo_dado = "Absoluto", .tipo_grafico = "linha")
area <- benCorrido::grafico_oferta_interna_energia(con, .tipo_dado = "Absoluto", .tipo_grafico = "area")
...
benCorrido::tab_oferta_interna_energia(con, .tipo = "Percentual")
...
linha <- benCorrido::grafico_oferta_interna_energia(con, .tipo_dado = "Percentual", .tipo_grafico = "linha")
area <- benCorrido::grafico_oferta_interna_energia(con, .tipo_dado = "Percentual", .tipo_grafico = "area")
...
benCorrido::tab_consumo_final_fonte(con, .tipo = "Absoluto")
...
linha <- benCorrido::grafico_consumo_final_fonte(con, .tipo_dado = "Absoluto", .tipo_grafico = "linha")
area <- benCorrido::grafico_consumo_final_fonte(con, .tipo_dado = "Absoluto", .tipo_grafico = "area")
...
benCorrido::tab_consumo_final_fonte(con, .tipo = "Percentual")
...
linha <- benCorrido::grafico_consumo_final_fonte(con, .tipo_dado = "Percentual", .tipo_grafico = "linha")
area <- benCorrido::grafico_consumo_final_fonte(con, .tipo_dado = "Percentual", .tipo_grafico = "area")
...
benCorrido::tab_consumo_final_setor(con, .tipo_dado = "Absoluto")
...
linha <- benCorrido::grafico_consumo_final_setor(con, .tipo_dado = "Absoluto", .tipo_grafico = "linha")
area <- benCorrido::grafico_consumo_final_setor(con, .tipo_dado = "Absoluto", .tipo_grafico = "area")
...
benCorrido::tab_consumo_final_setor(con, .tipo = "Percentual")
...
linha <- benCorrido::grafico_consumo_final_setor(con, .tipo_dado = "Percentual", .tipo_grafico = "linha")
area <- benCorrido::grafico_consumo_final_setor(con, .tipo_dado = "Percentual", .tipo_grafico = "area")
...
#| fig-cap: 'Composição Setorial do Consumo de Derivados de Petróleo.'
...
#| fig-cap: 'Composição Setorial do Consumo de Eletricidade.'
...
#| fig-cap: 'Composição Setorial de Consumo de Carvão Vapor.'
...
```{r}
#| label: fig-composicao-setorial-consumo-biomassa-absoluto
#| fig-cap: 'Composição Setorial do Consumo Final de Biomassa.'
...
```{r}
#| label: fig-composicao-setorial-consumo-biomassa-percentual
#| fig-cap: 'Composição Setorial do Consumo Final de Biomassa.'
...
#| fig-cap: 'Oferta Interna de Energia.'
...
```{r}
#| fig-cap: 'Fluxo de Energia Elétrica - BEN 2024/ano base 2023'
