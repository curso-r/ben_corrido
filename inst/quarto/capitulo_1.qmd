...
```{r}
#| label: tab-producao-energia-primaria-abs
...
```{r}
#| label: fig-producao-energia-primaria-abs
#| fig-cap: 'Produção de Energia Primária (valores absolutos).'
#| fig-height: 6
#| fig-width: 8

benCorrido::grafico_producao_energia_primaria_area(con, .tipo = "Absoluto")
```

## Valor percentual

```{r}
#| label: tab-producao-energia-primaria-perc
...
```{r}
#| label: fig-producao-energia-primaria-perc
#| fig-cap: 'Produção de Energia Primária (valores percentuais).'
#| fig-height: 6
#| fig-width: 8

benCorrido::grafico_producao_energia_primaria_area(con, .tipo = "Percentual")
```

:::

```{r}
#| label: tab-oferta-interna-energia-1
#| fig-cap: 'Oferta Interna de Energia'

reactable::reactable(mtcars[1:10,])
```

```{r}
#| label: fig-oferta-interna-energia-1
#| fig-cap: 'Oferta Interna de Energia'

plot(1:10)
```
```{r}
#| label: tab-consumo-final-fonte
#| fig-cap: 'Consumo Final por Fonte'

reactable::reactable(mtcars[1:10,])
```

```{r}
#| label: fig-consumo-final-fonte
#| fig-cap: 'Consumo Final por Fonte'
...
```{r}
#| label: tab-consumo-final-setor
#| fig-cap: 'Consumo Final por Setor'

reactable::reactable(mtcars[1:10,])
```

```{r}
#| label: fig-consumo-final-setor
#| fig-cap: 'Consumo Final por Setor'
...
```{r}
#| label: tab-consumo-final-energetico-fonte
#| fig-cap: 'Consumo Final Energético por Fonte'

reactable::reactable(mtcars[1:10,])
```

```{r}
#| label: tab-consumo-final-nao-energetico-fonte
#| fig-cap: 'Consumo Final Não Energético por Fonte'

reactable::reactable(mtcars[1:10,])
```

```{r}
#| label: tab-dependencia-externa-energia
...
```{r}
#| label: tab-composicao-setorial-consumo-derivados-petroleo
...
```{r}
#| label: fig-composicao-setorial-consumo-derivados-petroleo
#| fig-cap: 'Composição Setorial do Consumo de Derivados de Petróleo'
...
```{r}
#| label: tab-composicao-setorial-consumo-eletricidade
...
```{r}
#| label: fig-composicao-setorial-consumo-eletricidade
#| fig-cap: 'Composição Setorial do Consumo de Eletricidade'
...
```{r}
#| label: tab-composicao-setorial-consumo-carvao
...
```{r}
#| label: fig-composicao-setorial-consumo-carvao
#| fig-cap: 'Composição Setorial de Consumo de Carvão Vapor'
...
```{r}
#| label: tab-composicao-setorial-consumo-final-biomassa
...
```{r}
#| label: fig-composicao-setorial-consumo-final-biomassa
#| fig-cap: 'Composição Setorial do Consumo Final de Biomassa'
...
```{r}
#| label: tab-oferta-interna-energia-2
#| fig-cap: 'Oferta Interna de Energia'
...
```{r}
#| label: fig-oferta-interna-energia-2
#| fig-cap: 'Oferta Interna de Energia'
...
#| fig-cap: 'Fluxo Energético - BEN 2024/ano base 2023'
